...
# Form implementation generated from reading ui file 'c:\Users\user\Desktop\ROS2-with-YOLOv5\example\example\untitled.ui'
#
...
"border-color: rgb(255,0,0)")
        ...
        self.camera_btn.setGeometry(QtCore.QRect(210, 540, 89, 25))
        self.camera_btn.setObjectName("camera_btn")
        self.detect_checkbox = QtWidgets.QCheckBox(self.centralwidget)
        self.detect_checkbox.setGeometry(QtCore.QRect(230, 510, 92, 23))
        ...
        self.view_label.setGeometry(QtCore.QRect(10, 10, 640, 480))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 510, 160, 71))
        ...
        self.delay_text = QtWidgets.QLabel(self.formLayoutWidget)
        self.delay_text.setObjectName("delay_text")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.delay_text)
        self.delay_value = QtWidgets.QLabel(self.formLayoutWidget)
        self.delay_value.setObjectName("delay_value")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.delay_value)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ros"))
        ...
        self.delay_text.setText(_translate("MainWindow", "Delay"))
        self.delay_value.setText(_translate("MainWindow", "0ms"))
